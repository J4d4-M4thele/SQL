...
ORDER BY area_land DESC--largest to smallest land area
LIMIT 3;

SELECT geo_name, state_us_abbreviation, internal_point_lon
FROM us_counties_2010
ORDER BY internal_point_lon DESC--counties by longitude, largest to smallest
LIMIT 5;--retrieve only 5 rows
