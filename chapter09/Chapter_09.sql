--listing 9.1(creating table and importing data)
...
--listing 9.2(finding multiple co.s at same address)
SELECT company,
street,
city,
st,
...
--listing 9.5(finding inconsistent data using GROUP BY and count())
SELECT company,
...
--listing 9.6(using length() and count())
SELECT length(zip),
...
--listing 9.7(filtering out short zip codes)
SELECT st,
count(*) AS state_count
FROM meat_poultry_egg_inspect
WHERE length(zip) < 5
