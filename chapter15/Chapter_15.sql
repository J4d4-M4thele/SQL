...
--won't work because only id 1 is accepted 
INSERT INTO employees_tax_dept (first_name, last_name, dept_id)
...
--functions for percent change = (New Number – Old Number) / Old Number
...
--(old value, new value, decimal places)
